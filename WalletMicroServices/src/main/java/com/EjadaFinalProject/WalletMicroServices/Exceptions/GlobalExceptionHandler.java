...
import com.EjadaFinalProject.WalletMicroServices.Dto.ErrorDto;
...
public class GlobalExceptionHandler extends  ResponseEntityExceptionHandler {
    ...
    public final ResponseEntity<ErrorDto> handleUserExistsExceptions(Exception ex, WebRequest request) throws Exception {
        ErrorDto errorDetails = new ErrorDto(LocalDateTime.now(),
                ex.getMessage(), request.getDescription(false));
